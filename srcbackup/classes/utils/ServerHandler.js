...
class ServerHandler {
    ...
    sendApiHandlerRequest(message_data, extra_data) {

        try {
            /*
                        let url = Config.AI_SERVICE_URL + req_type;
                        ...
                        return new Promise((resolve, reject) => {
                            ...
                            try {
                                ...
                                console.log("[sendApiHandlerRequest] ====Promise====== ");
                                ...
                                fetch(url, {
                                    ...
                                    console.log("Error in sendApiHandlerRequest :: " + error);
                                    reject({ error, headersData });
                                });
