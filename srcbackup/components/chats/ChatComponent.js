...
class ChatComponents {
    ...
    displaySMS_MMS_Message(message, onClickSMSAction) {
                            ...
                            <>
                                ...
                                {message.delivery_status && message.delivery_status > 0 ? (
                                    ...
                                    <>
                                        ...
                                        <div className="cursor-pointer me-3 text-small" onClick={() => onClickSMSAction(parsedMessage, REQ_TYPE_SMS_ACTION.ACTION_RESEND)}>
                                            <img src={Send} alt="Resend" title="" className="replyIcons" />
                                        </div>

                                        <div className="cursor-pointer me-3 text-small" onClick={() => onClickSMSAction(parsedMessage, REQ_TYPE_SMS_ACTION.ACTION_EDIT)}>
                        ...
                        <MDBModalDialog centered>
                            <MDBModalContent>
                                <MDBModalHeader>
                                    ...
                                    <MDBBtn className='btn-close' color='none' onClick={() => setPopUpVisible(false)}></MDBBtn>
                                </MDBModalHeader>
                                <MDBModalBody>
